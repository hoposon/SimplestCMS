...
function parentDirPath(dirs, newDirId) {
	...
	// console.log('object keys >>> ', Object.keys(orderedDirs))
	// let parentIndex = Object.keys(orderedDirs).findIndex(key => {
	// 	console.log('key >>>> ', key)
	// 	return parseInt(key.substring(key.lastIndexOf('/')+1)) == newDirId
	// });
	// if (parentIndex > -1) {
	// 	let key = Object.keys(orderedDirs)[parentIndex];
	...
	// 	while(key.length > 0) {
	// 		key.pop();
	// 		console.log('keyp.pop >>> ', key)
	// 		finalPath = orderedDirs[key.join('/')].dirName + '/' + finalPath;
	// 		console.log('finalPath >>>>> ', finalPath)
	// 	}
	// 	console.log('finalPath dinal >>>>> ', finalPath)
	// 	return finalPath;
	// }
